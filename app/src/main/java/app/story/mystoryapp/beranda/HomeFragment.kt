...
import app.story.mystoryapp.adapter.LoadingStateAdapter
import app.story.mystoryapp.adapter.StoryListAdapter
import app.story.mystoryapp.databinding.FragmentHomeBinding
import app.story.mystoryapp.main.MainActivity
import app.story.mystoryapp.story.CreateStory
import app.story.mystoryapp.viewmodel.HomeViewModel
...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.fabCreateStory?.setOnClickListener {
            Intent(requireContext(), CreateStory::class.java).also { intent ->
